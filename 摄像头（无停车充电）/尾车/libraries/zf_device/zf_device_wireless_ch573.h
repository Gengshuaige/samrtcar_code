...
#define WIRELESS_CH573_INDEX             UART_7                                      // CH573无线模块1 对应使用的串口号
#define WIRELESS_CH573_BUAD_RATE         115200                                      // CH573无线模块1 对应使用的串口波特率
#define WIRELESS_CH573_TX_PIN            UART7_MAP3_RX_E13                                 // CH573无线模块1 对应模块的 TX 要接到单片机的 RX
#define WIRELESS_CH573_RX_PIN            UART7_MAP3_TX_E12                                 // CH573无线模块1 对应模块的 RX 要接到单片机的 TX
#define WIRELESS_CH573_RTS_PIN           E8                                         // CH573无线模块1 对应模块的 RTS 引脚
