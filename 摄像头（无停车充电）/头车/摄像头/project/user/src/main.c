...
bool turn_left;
bool turn_right;
bool shexiangtou_or_dianci = true;
...
//            bibibi(1);
            if(delay_stop_my_2s==401){
                ...
                //动态预瞄点
//                sport_Point_follow();
                aim_distance_sport((shiji_speed_L-shiji_speed_R)/2,0.01);
                //识别部分
                TELL();
                //中线归一化
                zhongxianGuiyihua();
...
//    tft180_show_int(0, 0, imu660ra_gyro_z, 6 );
...
//    tft180_show_float(0, 100, pid_shuchu_speed_L, 6 , 2);
//    tft180_show_float(0, 80, pid_shuchu_speed_R, 6 , 2);
...
////      tft180_show_string(0,0,"first:");
////      tft180_show_int(71, 0, first_type, 6 );
...
//    tft180_show_string(0, 0, "from two:");
//    tft180_show_int(0, 20, read_ceshi,3);
}
