...
void dianji_control(void){
    ...
    //检查长直道
        ...
        my_qiwang_speed = 90*zf_bianmaqi_duqu;
    }
...
void duoji_control(void)
{
    ...
    if(circle_type!=CIRCLE_NONE) {
        ...
        if(circle_type == CIRCLE_RIGHT_OUT) pure_angle = -17;
        if(circle_type == CIRCLE_LEFT_IN) pure_angle = 60;
        if(circle_type == CIRCLE_RIGHT_IN) pure_angle = -60;
    }
/*************************************************************/
    //别tm开这个!!!
    //调试用的!!!
