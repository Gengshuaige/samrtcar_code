...
//                        draw_point(far_x6, far_y6, RGB565_RED);
                        far_Lpt0_rpts0s_16 = check_16point(far_x6,far_y6);
                        far_Lpt0_found = true;
                        break;
                        }
...
//                               tft180_show_int(0, 130, far_Lpt1_rpts1s_id, 6);
                               ...
                               far_Lpt1_rpts1s_16 = check_16point(far_x6,far_y6);
                               if(far_y<far_y7)
...
void check_cross(void) {
    ...
    if(Xfound){
        //L角点的二次检查
        if(Lpt1_rpts1s_id<7 && Lpt0_rpts0s_id<7 && check_far_whitepoint(x6,y6) && check_far_whitepoint(x7,y7))
        {
